...
<script>
        ...
        function my_search(data) {
            ...
            $.getJSON({
                ...
                success: function (res) {
                    ...
                    Timetable.setOption({//实例化上的方法，重新设置参数渲染表格
                        timetables: courseListOther,//日程表内容，格式为二维数组
                        gridOnClick: function (e) {//点击单元格触发事件
                        ...
                        timetableType: courseType//日程表左侧部分内容
                    });
                }
            });
        }
    ...
    var Timetable = new Timetables({
        el: '#coursesTable',
        timetables: courseList,//日程表内容
        week: week,//日期表头部周
        timetableType: courseType,//日程表左侧内容
        highlightWeek: day,//传入表头当天的索引，为日程表头部高亮某周增加一个class(可自定义样式)
