...
<script>
    layui.use(['layer', 'miniTab', 'form', 'table','laydate'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: 'article/student/queryArticles.do',//前端传入总的数量，和数据
            cols: [[
            ...
            limit: 15,//每页显示的条数。laypage将会借助 count 和 limit 计算出分页数。
            page: {
                prev: '上一页',
                next: '下一页',
            }
        ...
        form.on('submit(data-all-btn)', function (data) {
            ...
            table.reload('currentTableId', {
                ...
                page: {curr: 1}, //重新从第 1 页开始
                    ...
                    layer.msg("全部显示了"+res.count+"个结果", {time:800});
                    return res;
                }
            });
