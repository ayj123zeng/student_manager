...
<head>
    ...
    <style>
        ...
        body{background: url("http://localhost:8080/student_manager_war/layuimini/images/bg.jpg");background-size: 100%;}
...
<script>
    ...
    $("#code_pic").click(function () {
        //后面加上new Date()是为了防止浏览器缓存，得到的验证码是一样的
    ...
    layui.use(['form'], function () {
        var form = layui.form,
            layer = layui.layer;
        //按了记住密码后，会存入cookie，时间为一周,这样每次访问就可以拿到cookie的值，
        //并给from表单赋值
                    ...
                    * */
                    switch (res) {
                        case 3:
                            ...
                            //prop设置或返回被选元素的属性的值
                            $("#code_pic").prop("src","kaptcha.jpg?d=" + new Date());
                            break;
                        case 0:
                        ...
                        case 2: //登录成功
                            ...
                            if(data.rememberMe == "true") {   //记住密码了
                                ...
                                //创建 cookie，并设置 cookie 的有效路径，路径为网站的根目录,过期时间为date
