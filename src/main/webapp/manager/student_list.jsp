    ...
    <div class="layui-form" style="width: 400px; float: left" lay-filter="editForm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="sname" name="sname" value="" lay-verify="required" lay-reqtext="姓名不能为空"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" id="snum" name="snum" value="" lay-verify="required" lay-reqtext="学号不能为空"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="entime" name="entime" value="" lay-verify="date" placeholder="请选择入学时间"
                       class="layui-input">
            </div>
        </div>
        <!--登录密码-->
    ...
    <div class="layuimini-main">
            ...
            <div style="margin: 10px 10px 10px 10px">
                <form class="layui-form layui-form-pane" action="" lay-filter="searchForm">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <button type="submit" class="layui-btn layui-btn-primary" lay-submit
                                    lay-filter="data-all-btn"><i class="layui-icon"></i> 显示全部
                            </button>
                        </div>
                    </div>
                </form>
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                ...
                <button class="layui-btn layui-btn-sm layui-btn-danger data-delete-btn" lay-event="delete"> 删除选中行
                </button>
                <button class="layui-btn layui-btn-sm data-plan-btn" lay-event="seeInfo"> 查看学生信息</button>
                <button class="layui-btn layui-btn-normal layui-btn-sm data-plan-btn"
                        lay-event="outputStudentInformation"> 导出所有学生信息
                </button>
            </div>
        </script>
        <!--表格容器-->
...
<script>
    layui.use(['form', 'table', 'laydate', "upload", "element", "layer"], function () {
        ...
        var uploadInst = upload.render({
            ...
            before: function (obj) {
                ...
                obj.preview(function (index, file, result) {
                    //index得到文件的索引，file得到文件对象，result得到base64编码，比如图片
        ...
        $(function () {
            ...
            $.getJSON({
                ...
                success: function (data) {
                    //返回第一个匹配元素的内容
                    $("#search_cid").html();
                    //对搜索框的select进行option赋值
                    $.each(data, function (i, n) {//i是对应下标，n是对应下标对应的值，对数据，json等的遍历
                        $("#search_cid").append("<option value=\"" + n.cid + "\">" + n.cname + "</option>")
                    });
                    form.render('select', 'searchForm'); //刷新select选择框渲染
                    $("#edit_cid").html();
                    //对弹出编辑框的select进行option赋值
                    $.each(data, function (i, n) {
                        $("#edit_cid").append("<option value=\"" + n.cid + "\">" + n.cname + "</option>")
                    });
        ...
        table.render({
            ...
            //自定义头部工具栏
            toolbar: '#toolbarDemo',
            //头部右侧导航栏：filter:显示筛选图标，exports：显示导出图标，print：打印图标
        ...
        form.on('submit(data-search-btn)', function (data) {
            ...
            table.reload('currentTableId', {
                ...
                where: {json: result},   //把json传过去,设定异步数据接口的额外参数
